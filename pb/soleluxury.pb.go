...
var file_soleluxury_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xd3, 0x06, 0x0a, 0x0a, 0x53, 0x6f, 0x6c, 0x65, 0x6c, 0x75, 0x78, 0x75, 0x72, 0x79,
	...
	0x2d, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x73, 0x42, 0x70, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_soleluxury_proto_goTypes = []interface{}{
	...
	(*CreateStoreResponse)(nil), // 7: pb.CreateStoreResponse
	(*GetStoreResponse)(nil),    // 8: pb.GetStoreResponse
	(*GetStoresResponse)(nil),   // 9: pb.GetStoresResponse
}
var file_soleluxury_proto_depIdxs = []int32{
	...
	5, // 6: pb.Soleluxury.CreateUser:output_type -> pb.CreateUserResponse
	6, // 7: pb.Soleluxury.LoginUser:output_type -> pb.LoginUserResponse
	7, // 8: pb.Soleluxury.CreateStore:output_type -> pb.CreateStoreResponse
	8, // 9: pb.Soleluxury.GetStore:output_type -> pb.GetStoreResponse
	8, // 10: pb.Soleluxury.GetFirstStore:output_type -> pb.GetStoreResponse
	9, // 11: pb.Soleluxury.GetStores:output_type -> pb.GetStoresResponse
